...
template <typename Cell, ScreenType TheScreenType>
unique_ptr<ParserExtension> Screen<Cell, TheScreenType>::hookGoodImageUpload(Sequence const&)
{
...
template <typename Cell, ScreenType TheScreenType>
unique_ptr<ParserExtension> Screen<Cell, TheScreenType>::hookGoodImageRender(Sequence const&)
{
    return make_unique<MessageParser>([this](Message&& _message) {
        auto const name = _message.header("n");
...
template <typename Cell, ScreenType TheScreenType>
unique_ptr<ParserExtension> Screen<Cell, TheScreenType>::hookGoodImageRelease(Sequence const&)
{
    return make_unique<MessageParser>([this](Message&& _message) {
...
template <typename Cell, ScreenType TheScreenType>
unique_ptr<ParserExtension> Screen<Cell, TheScreenType>::hookGoodImageOneshot(Sequence const&)
{
    return make_unique<MessageParser>([this](Message&& _message) {
        auto const screenRows = LineCount::cast_from(toNumber(_message.header("r"), 0));
        auto const screenCols = ColumnCount::cast_from(toNumber(_message.header("c"), 0));
...
template <typename Cell, ScreenType TheScreenType>
void Screen<Cell, TheScreenType>::uploadImage(string _name,
                                              ImageFormat _format,
                                              ImageSize _imageSize,
                                              Image::Data _pixmap)
{
...
template <typename Cell, ScreenType TheScreenType>
void Screen<Cell, TheScreenType>::renderImageByName(std::string const& _name,
                                                    GridSize _gridSize,
                                                    PixelCoordinate _imageOffset,
                                                    ImageSize _imageSize,
                                                    ImageAlignment _alignmentPolicy,
...
template <typename Cell, ScreenType TheScreenType>
void Screen<Cell, TheScreenType>::renderImage(ImageFormat _format,
                                              ImageSize _imageSize,
                                              Image::Data _pixmap,
                                              GridSize _gridSize,
                                              ImageAlignment _alignmentPolicy,
...
template <typename Cell, ScreenType TheScreenType>
void Screen<Cell, TheScreenType>::releaseImage(std::string const& _name)
{
